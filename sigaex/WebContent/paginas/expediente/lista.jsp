...
function alteraForma(){
	ReplaceInnerHTMLFromAjaxResponse('<ww:property value="%{url}"/>'+'?forma='+document.getElementById('forma').value+'&idMod='+'${hisIdIni}', null, document.getElementById('comboModeloDiv'))
}

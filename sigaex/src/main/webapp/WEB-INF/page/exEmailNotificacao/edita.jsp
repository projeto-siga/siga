		...
		<div class="card bg-light mb-3" >
			...
			<div class="card-body">	
				...
				<div class="row">
					<div class="col-sm-2">
						<div class="form-group">
							<label for="tipoDest">Tipo de destinatário da movimentação</label>
							<select name="tipoDest"  id="tipoDest" onchange="javascript:hideShowSel(this);" class="form-control" >
					...
					<div class="col-sm-5">
						<div class="form-group">
							...
							<span id="spanPessDest" style="${destMovStyle}">
								 <siga:selecao propriedade="pess" tema="simple" modulo="siga"/> 
							</span> 
							<span id="spanLotaDest" style="${lotaDestMovStyle}"> 
								<siga:selecao propriedade="lota" tema="simple" paramList="${strBuscarFechadas}" modulo="siga"/> 
							</span>										
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-sm-2">
						<div class="form-group">
							<label for="tipoDest">Tipo de interessado na movimentação</label>
							<select name="tipoEmail" id="tipoEmail" onchange="javascript:hideShowSel(this);" class="form-control" >
					...
					<div class="col-sm-5">
						<div class="form-group">
							...
							<span id="spanPessEmail" style="${emailMovStyle}">
								<siga:selecao propriedade="pessEmail" tema="simple" modulo="siga"/>
							</span> 
							<span id="spanLotaEmail" style="${lotaEmailMovStyle}"> 
								<siga:selecao propriedade="lotaEmail" tema="simple" paramList="${strBuscarFechadas}" modulo="siga"/>
							</span>
							<span id="spanTextEmail" style="${emailStyle}">
								<input type="text" name="emailTela" size="40" maxLength="40" class="form-control"/> 
							</span> 										
						</div>
					</div>
				</div>

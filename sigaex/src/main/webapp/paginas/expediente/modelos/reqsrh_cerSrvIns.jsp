...
@page {
	...
	margin-bottom: 1cm;
		...
		<c:import url="/paginas/expediente/modelos/inc_cabecalhoCentralizadoPrimeiraPagina.jsp" />
		   ...
		   <tr bgcolor="#FFFFFF">
				<td width="100%">
					<table width="100%">
						<tr><br><br>
						<td align="center"><p style="font-family:Arial;font-weight:bold;font-size:11pt;">CERTIDÃO COMPROVANDO CONDIÇÃO DE SERVIDOR</p></td>
						</tr>
					</table>
				</td>
			</tr>
		...
		<p style="text-align: center;font-weight:bold;font-size:11pt;"><center><br><br><b> ${ilustrissimo} DA SECRETARIA DE RECURSOS HUMANOS</center></b></p>
			...
			ramal ${ramal}, vem requerer a Vossa Senhoria que seja expedida <b>Certidão</b> comprovando a sua condição de servidor desta Egrégia Corte, contendo o respectivo endereço e CNPJ desta, bem como a data de sua posse.
			<br><br>
			Esclarece, outrossim, serem estes dados necessários ao Instituto Nacional de Seguridade Social, para fins de emissão de certidão de tempo de serviço.

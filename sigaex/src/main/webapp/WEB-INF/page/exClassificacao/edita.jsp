...
<c:choose>
					...
					<div class="row">
						<div class="col-sm-2">
							<div class="form-group">
								...
								<input id="codificacao" class="form-control" name="exClassificacao.codificacao" type="text" value="${exClassificacao.codificacao}" onblur="javascript:aplicarMascara(this)" />
					...
					<div class="row">
						<div class="col-sm">
							<div class="form-group">
								...
								<input id="descrClassificacao" name="exClassificacao.descrClassificacao" type="text" value="${exClassificacao.descrClassificacao}" class="form-control"/>							
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-sm">
							<div class="form-group">
								...
								<input id="obs" name="exClassificacao.obs" type="text" value="${exClassificacao.obs}" class="form-control"/>							
							</div>
						</div>
					</div>
	...
	<div id="botoesClassificacao">
		<div class="row">
			<div class="col-sm">
				<button type="button" class="btn btn-primary" id="btGravarClassificacao" onclick="javascript:gravarClassificacao()" >Gravar</button>	
				<c:choose>
					<c:when test="${acao == 'editar_classificacao'}">
							<button type="button" class="btn btn-primary" id="btGravarClassificacao" onclick="javascript:location.href='excluir?codificacao=${exClassificacao.codificacao}'" >Excluir</button>
							<button type="button" class="btn btn-primary" id="btGravarClassificacao" onclick="javascript:location.href='listar'" >Voltar</button>
					</c:when>
					<c:otherwise>
							<button type="button" class="btn btn-primary" id="btGravarClassificacao" onclick="javascript:location.href='listar'" >Cancelar</button>
					</c:otherwise>
				</c:choose>
			</div>	
		</div>
		...
		<c:if test="${acao == 'editar_classificacao'}">
			<c:if test="${exibirAdicaoDeVia}">
				<div class="row mb-3">
					<div class="col-sm">
						<button type="button" class="btn btn-primary" id="btGravarClassificacao" onclick="javascript:adicionarVia()" >Adicionar Via</button>
					</div>
				</div>
			</c:if>
		</c:if>
	...
	<c:if test="${acao == 'editar_classificacao'}">
		<c:if test="${exClassificacao.numVias > 0}">
			<div class="card bg-light mb-3">
				...
				<div id="divVias" class="card-body">
						...
						<tbody>
							<c:forEach items="${exClassificacao.exViaSet}" var="via">
								<tr id="divVia_${via.id}" class="viasExistentes" >
									...
									<td>
										<a id="btEditarVia" class="btn btn-warning text-white" style="cursor: pointer;" onclick="javascript:editarExVia(${via.id})" title="Editar Via"><i class="fa fa-edit"></i></a>
										<c:if test="${via.codVia == exClassificacao.numVias}">
											<a class="btn btn-danger" href="excluirVia?idVia=${via.id}&codificacao=${exClassificacao.codificacao}&acao=${acao}" title="Excluir Via"><i class="fa fa-trash-alt"></i></a>
										</c:if>
									</td>
								</tr>
			
								<!-- EDICAO VIA -->
								<div id="divViaEdicao_${via.id}" style="display: none" class="border" >
										...
										<div class="pr-2 pl-2">
											...
											<div class="row">
												<div class="col-sm">
													<div class="form-group">
														<label>Destino</label> 
														<select id="idDestino" name="idDestino" class="custom-select"> 
											...
											<div class="row">
												<div class="col-sm-6">
													<div class="form-group">
														...
														<select id="idTemporalidadeArqCorr" name="idTemporalidadeArqCorr" class="custom-select"> 
												...
												<div class="col-sm-6">
													<div class="form-group">
														...
														<select id="idTemporalidadeArqInterm" name="idTemporalidadeArqInterm" class="custom-select"> 
															<option value="-1">[Sem valor]</option>
															<c:forEach items="${listaExTemporalidade}" var="itemLista">
																<c:choose>
											...
											<div class="row">
												<div class="col-sm">
													<div class="form-group">
														...
														<select id="idDestinacaoFinal" name="idDestinacaoFinal" class="custom-select"> 
															<option value="-1">[Sem valor]</option>
															<c:forEach items="${listaExTipoDestinacao}" var="itemLista">
																<c:choose>
											...
											<div class="row">
												<div class="col-sm">
													<div class="form-group">
														<label>Observação</label> 
														<input id="obs" name="obsVia" type="text" value="${via.obs}" size="100" class="form-control"/>
													</div>
												</div>
											</div>
											...
											<div class="row pb-3 mb-3">
												<div class="col-sm">
													<button type="button" class="btn btn-primary" id="btGravarClassificacao" onclick="javascript:gravarExVia(${via.idVia});" >Gravar Via</button>
													<button type="button" class="btn btn-primary" id="btGravarClassificacao" onclick="javascript:cancelarEdicaoVia(${via.idVia});" >Cancelar Via</button>
												</div>
											</div>
										</div>
									</form>
					...
					<input type="hidden" name="codificacao" value="${exClassificacao.codificacao}"/>
						<div class="row">
							<div class="col-sm">
								<div class="form-group">
									<label>Destino</label>
									<select  name="idDestino" theme="simple" class="custom-select">
						...
						<div class="row">
							<div class="col-sm">
								<div class="form-group">
									<label>Arquivo Corrente</label>
									<select  name="idTemporalidadeArqCorr" theme="simple" class="custom-select">
							...
							<div class="col-sm">
								<div class="form-group">
									<label>Arquivo Intermediário</label>
									<select  name="idTemporalidadeArqInterm" theme="simple" class="custom-select">
						...
						<div class="row">
							<div class="col-sm">
								<div class="form-group">
									<label>Destinação Final</label>
									<select  name="idDestinacaoFinal" theme="simple" class="custom-select">
						...
						<div class="row">
							<div class="col-sm">
								<div class="form-group">
									<label>Observação</label>
									<input id="obs" name="obsVia" type="text" class="form-control" />
						...
						<div class="row">
							<div class="col-sm">
								<button type="button" class="btn btn-primary" id="btGravarClassificacao" onclick="javascript:gravarExVia(0)" >Gravar Via</button>
								<button type="button" class="btn btn-primary" id="btGravarClassificacao" onclick="javascript:cancelarNovaVia();" >Cancelar Via</button>
							</div>

			...
			<tr bgcolor="#FFFFFF">
				<td width="100%"> 
					<table width="100%" border="0" cellpadding="2">
						...
						<tr>
							<td width="100%" align="center" style="font-family:AvantGarde Bk BT, Arial;font-size:8pt;"><c:choose><c:when test="${not empty doc.cadastrante.descricao}">${doc.lotaCadastrante.orgaoUsuario.descricaoMaiusculas}</c:when><c:otherwise>SEÇÃO JUDICIÁRIA DO RIO DE JANEIRO</c:otherwise></c:choose></td>
						</tr>
					</table>
				</td>
			</tr>

...
public class GcArquivo extends GenericModel implements Serializable {
	...
	/**
	 * Duplica o conteúdo de um conhecimento através de serialização. Uma
	 * das formas de se fazer deep copying do conteúdo, assim quando alterar a
	 * cópia não modifica o original
	 */

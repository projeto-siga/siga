	...
	<table width="100%" class="zero">
		<tr>
			<td>
				...
				<input type="button" name="ok" value="Ok" onclick="javascript:submitOk();" /> 
				<c:url var="url" value="/app/expediente/doc/editar"/>
			</td>
			<td>
				<input type="submit" align="right" name="novo" value="Novo" title="Criar Novo Expediente" onclick="javascript:frm.action='${url}';" />
			</td>
		</tr>
	</table>
</form>

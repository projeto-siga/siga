...
public class AllReferencesGet implements IXjusRecordAPI.IAllReferencesGet {
	...
	private static final String HQL = "select mov.idMov from ExMovimentacao mov where mov.exTipoMovimentacao in :tpmovs and (mov.exMobil.exDocumento.dtFinalizacao != null and mov.exMobil.exDocumento.dtPrimeiraAssinatura != null) and (mov.idMov > :id) order by mov.idMov";

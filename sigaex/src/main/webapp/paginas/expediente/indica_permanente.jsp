...
function sbmt() {
	...
	ExMovimentacaoForm.acao.value='aIndicarPermanente';
...
<c:if test="${not mob.doc.eletronico}">
	...
	<div class="gt-bd clearfix">
		<div class="gt-content clearfix">
			...
			<h2>Indica̤̣o para Guarda Permanente - ${mob.siglaEDescricaoCompleta}</h2>

			<div class="gt-content-box gt-for-table">

			<ww:form action="indicar_permanente_gravar"
				...
				<table class="gt-form-table">
					<tr class="header">
						<td colspan="2">Dados da indica̤̣o</td>
					</tr>

...
<mod:modelo>
	<mod:entrevista>
		...
		<mod:grupo>
			<mod:texto titulo="Nome do(a) candidato(a)" var="nome" largura="50"/>
		</mod:grupo>
		<mod:grupo>
...
<c:if test="${tipo == 'Candidato'}">
		<mod:grupo>
			<mod:texto titulo="Cargo no qual deverá tomar posse" var="cargo" largura="30"/>
				...
				<mod:grupo>
			<mod:texto titulo="Área referente ao cargo" var="area" largura="30"/>
		</mod:grupo>
				<mod:grupo>
			<mod:data titulo="Data em que se exaure o prazo para a posse do(a) candidato(a)" var="data"/>
		</mod:grupo>
</c:if>
			...
			<tr bgcolor="#FFFFFF">
				<td width="100%">
					...
					<table width="100%" border="0" >
						<tr>
							<td align="center"><mod:letra tamanho="${tl}"><p style="font-family:Arial;font-weight:bold" >MINUTA DE GUIA PR&Eacute;-ADMISSIONAL</p></mod:letra></td>
						</tr>
						<tr>
...
efeito de posse no cargo de ${cargo}, Área ${area}. Outrossim, informo que o prazo para a posse se exaure em ${data}.

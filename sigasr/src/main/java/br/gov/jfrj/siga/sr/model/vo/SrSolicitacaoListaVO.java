...
public class SrSolicitacaoListaVO {
    ...
    public List<ColunasVO> gerarColunasSolicitacao(boolean telaDeListas, boolean podeRemover, boolean podePriorizar) {
        ...
        if (telaDeListas) {
            ...
            colunasVO.add(new ColunasVO("Lota&ccedil;&atilde;o", "lotaAtendenteFormatada", GT_CELULA_NOWRAP_SOLICITACAO_DADOS));
            colunasVO.add(new ColunasVO("&Uacute;�ltima Movimenta&ccedil;&atilde;o", ULTIMA_MOVIMENTACAOFORMATADA, GT_CELULA_NOWRAP_SOLICITACAO_DADOS));
            ...
            colunasVO.addAll(getColunasEmComum());
            colunasVO.add(new ColunasVO("Situa&ccedil;&atilde;o", "marcadoresEmHtml", GT_CELULA_NOWRAP_SOLICITACAO_DADOS));
            colunasVO.add(new ColunasVO("&Uacute;ltimo Andamento", ULTIMA_MOVIMENTACAOFORMATADA, GT_CELULA_NOWRAP_SOLICITACAO_DADOS));
    ...
    private List<ColunasVO> getColunasEmComum() {
        List<ColunasVO> colunasVO = new ArrayList<ColunasVO>();
        colunasVO.add(new ColunasVO("C&oacute;digo", "codigoFormatado", "gt-celula-nowrap solicitacao-codigo", LARGURA_COLUNA_CODIGO));
    ...
    public List<ColunasVO> gerarColunasDetalhamentoSolicitacao(boolean telaDeListas) {
        ...
        colunasDetalhamentoSolicitacao.add(new ColunasVO("Situa&ccedil;&atilde;o", "marcadoresEmHtmlDetalhes"));
        colunasDetalhamentoSolicitacao.add(new ColunasVO("&Uacute;ltima Movimenta&ccedil;&atilde;o", ULTIMA_MOVIMENTACAOFORMATADA));

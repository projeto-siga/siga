...
public class IncluirdocumentoIT extends DriverBase {
	...
	/**
	 * Caminho: Criar um processo generico, "Finalizar" e depois ir na aba "Incluir
	 * documento" Obs: Tem que ter uma classificação documental
	 * 
	...
	public void incluir() throws Exception {
		...
		driver.findElement(By.id("descrDocumento")).sendKeys("teste incluir");
		...
		driver.findElement(By.id("descrDocumento")).click();
		driver.findElement(By.id("descrDocumento")).sendKeys("teste incluir - depois que finalizar");
		driver.switchTo().frame(0);

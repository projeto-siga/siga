...
@Resource
public class GrupoOrgaoController extends GrupoController {

	public GrupoOrgaoController(HttpServletRequest request, Result result, SigaObjects so, EntityManager em) {
	...
	public void edita(Long idCpGrupo) throws Exception {
		...
		if (conf.podeUtilizarServicoPorConfiguracao(
				...
				|| conf.podeGerirGrupo(
						...
						getLotaTitular(),
						idCpGrupo,
						Long.valueOf(CpTipoGrupo.TIPO_GRUPO_ORGAO_TRAMITACAO))) {
	...
	@Post("app/gi/grupoOrgao/excluir")
	...
	@Get("app/gi/grupoOrgao/excluirGestorGrupo")
	...
	@Post("app/gi/grupoOrgao/gravarGestorGrupo")
	...
	@Get("app/gi/grupoOrgao/selecionar")

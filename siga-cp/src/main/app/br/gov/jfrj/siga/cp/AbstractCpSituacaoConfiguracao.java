...
public abstract class AbstractCpSituacaoConfiguracao extends Objeto implements Serializable {
	...
	@JoinTable(name = "cp_tipo_servico_situacao", catalog = "corporativo", joinColumns = { @JoinColumn(name = "ID_SIT_CONFIGURACAO", nullable = false, updatable = false) }, inverseJoinColumns = { @JoinColumn(name = "ID_TP_SERVICO", nullable = false, updatable = false) })

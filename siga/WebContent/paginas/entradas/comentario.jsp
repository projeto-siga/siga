...
<table>
	...
	<tr>
		<td style="padding-top: 7; padding-bottom: 7"><font size='2'
			align="justify"> <b>Novo Editor de Textos</b><br>
	
	O Siga-Doc possui um novo editor de textos, com mais recursos e menos problemas de formatação. Inicialmente, ele está disponível apenas em alguns modelos. Gradualmente, o antigo editor será substituído. <a href="AjudaEditorTextosSigaDoc.pdf"><b>Veja instruções</b></a> sobre o uso do editor.
	</font></td></tr>
	
	<tr>
		<td style="padding-top: 7; padding-bottom: 7"><font size='2'
			align="justify"> <b>Busca Textual Integrada</b><br>
	
	A busca de documentos por conteúdo agora pode ser feita na própria tela de pesquisa por filtros, por meio do campo Conteúdo.  
	</font></td></tr>
	
	<tr>
		<td style="padding-top: 7; padding-bottom: 7"><font size='2'
			align="justify"> <b>Assinador da Certisign</b><br>
	
	Agora a assinatura digital pode ser feita por meio de um recurso desenvolvido pela Certisign. Basta clicar em <b>Assinar com assinador da Certisign</b>, na tela de assinatura. A tecnologia facilitará, principalmente, o uso do Siga-Doc com certificado digital em outros órgãos.
	</font></td></tr> 
...
<c:if test="${param['completo'] eq 'true'}">
	...
	<tr>
		<td style="padding-top: 7; padding-bottom: 7"><font size='2'
			align="justify"> <b>Quadro de Solicitações</b><br>
		Assim como o módulo Documentos, o novo módulo Serviços também exibe um resumo na página inicial, dentro do <i>Quadro de Solicitações</i>.</font></td>
	</tr>

	<tr>
		<td style="padding-top: 7; padding-bottom: 7"><font size='2'
			align="justify"> <b>PCTT - nova versão</b><br>
		Está disponível para uso no sistema a nova tabela de classificação.
		O formato do código da classificação mudou para
		NN.NN.NN.NN. A maioria das classificações possui apenas uma
		via.</font></td>
	</tr>
	...
	<tr>
		...
		Na tela de visualização de documentos, o estado em que uma via se encontra agora é exibido mais acima, ao lado do número da via. <a style ="font-weight: bold" href="exibeEstado.htm" target="new">Veja a diferença na imagem</a>.</font></td>
	</tr>

	<tr>
		<td style="padding-top: 7; padding-bottom: 7"><font size='2'
			align="justify"> <b>Consulta a documentos</b><br>
		Agora é possível consultar documentos através do estado, incluindo <i>Transferido</i> e <i>Como Subscritor</i>. Basta selecionar a situação desejada na lista e, ao lado, a pessoa ou lotação a quem o estado se refere. <a style ="font-weight: bold" href="novaListaJsp.JPG" target="new">Veja a imagem</a>.</font></td>
	</tr>

	<tr>
		<td style="padding-top: 7; padding-bottom: 7"><font size='2'
			align="justify"> <b>Notificação de documentos a receber</b><br>
		É possível, por meio de chamado, especificar para quais endereços de
		e-mail o sistema deverá enviar notificação de transferência de documento
		eletrônico para uma determinada lotação.</font></td>
	</tr>
	
	<tr>
		<td style="padding-top: 7; padding-bottom: 7"><font size='2'
			align="justify"> <b>Documentos Eletrônicos</b><br>
		Agora todos os expedientes podem ser gerados e movimentados de forma
		totalmente digital, não necessitando ser impressos. Para gerar um
		documento eletrônico, marque a opção 'Digital', na parte superior da
		tela de edição do expediente.</font></td>
	</tr>
		...
		<tr>
			<td style="padding-top: 7; padding-bottom: 7"><font size='2'
				align="justify"> <b>Visualizar Dossiê</b><br>
			O recurso Visualizar Dossiê permite navegar mais facilmente pelos
			despachos, documentos filhos e anexos de um expediente, bem como
			visualizar ou imprimir seus conteúdos como um único documento.</font></td>
		</tr>
		...
		<tr>
			<td style="padding-top: 7; padding-bottom: 7"><font size='2'
				align="justify"> <b>Despacho Longo Diferente</b><br>
			Ao fazer um despacho longo, o usuário vê a tela para edição do
		...
		<tr>
			<td style="padding-top: 7; padding-bottom: 7"><font size='2'
				align="justify"> <b>Substituição Mais Fácil</b><br>
			Para mudar de perfil, basta passar o mouse sobre o seu nome, no
			rodapé, e selecionar a pessoa ou lotação desejada.</font></td>
		</tr>
		<tr>
			<td style="padding-top: 7; padding-bottom: 7"><font size='2'
				align="justify"> <b>Salvamento Automático</b><br>
			Os documentos são agora salvos automaticamente, a cada dois minutos.
		...
		<tr>
			...
			A busca por documentos pode agora ser feita não só por uma data fixa,
			mas tambem por intervalo de datas.</font></td>
		</tr>
		<tr>
			<td style="padding-top: 7; padding-bottom: 7"><font size='2'
				align="justify"> <b>Arquivamento em Lote</b><br>
			Está disponível o recurso que permite fazer o arquivamento corrente
			simultâneo de vários expedientes.</font></td>
		</tr>
		<tr>
			<td style="padding-top: 7; padding-bottom: 7"><font size='2'
				align="justify"> <b>Dedicada aos Subscritores</b><br>
		...
		<tr>
			...
			para facilitar a geração de resposta a um expediente. Quando
			assinado, um documento filho é automaticamente juntado ao pai. É
			possivel também, na criação de um expediente, definir qual o seu
			documento pai.</font></td>
		</tr>
		<tr>
			<td style="padding-top: 7; padding-bottom: 7"><font size='2'

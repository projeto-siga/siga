...
Insert into CORPORATIVO.CP_SERVICO (ID_SERVICO,SIGLA_SERVICO,DESC_SERVICO,ID_SERVICO_PAI,ID_TP_SERVICO) values (CP_SERVICO_SEQ.NEXTVAL,'GOGLOBAL','Acesso ao Go-Global',null,2);

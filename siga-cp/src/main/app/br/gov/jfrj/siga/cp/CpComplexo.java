...
@Table(name = "cp_complexo", catalog = "corporativo")
public class CpComplexo extends AbstractCpComplexo implements
		CpConvertableEntity {

	public static ActiveRecord<CpComplexo> AR = new ActiveRecord<>(
			CpComplexo.class);

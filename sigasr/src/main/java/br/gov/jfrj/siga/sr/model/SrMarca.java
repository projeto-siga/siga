...
@NamedNativeQuery(name = "contarSrMarcas", query = "" + "SELECT m.id_marcador, m.descr_marcador, c.cont_pessoa, c.cont_lota, c.cont_unassigned " + "FROM " + Catalogs.CORPORATIVO + ".cp_marcador m, "
        ...
        + "		SUM(CASE WHEN id_lotacao_ini = :idLotacaoIni and id_pessoa_ini is null THEN 1 ELSE 0 END) cont_unassigned " + "		FROM " + Catalogs.CORPORATIVO + ".cp_marca marca"

	...
	<tr>
		<td style="padding-top: 7; padding-bottom: 7"><font size='2'
			align="justify"> <b>PCTT - nova versão</b><br> Está
				...
				formato do código da classificação mudou para NN.NN.NN.NN. A maioria
				das classificações possui apenas uma via.</font></td>
	</tr>
	...
	<tr>
		<td style="padding-top: 7; padding-bottom: 7"><font size='2'
			align="justify"> <b>Notificação de documentos a receber</b><br>
				...
				e-mail o sistema deverá enviar notificação de transferência de
	...
	<tr>
		<td style="padding-top: 7; padding-bottom: 7"><font size='2'
			align="justify"> <b>Caixa "Ir para o documento"</b><br> O
				campo de busca por código de expediente agora está disponível também
				nas páginas de listagem e de exibição de documentos.</font></td>
	</tr>

	<tr>
		<td style="padding-top: 7; padding-bottom: 7"><font size='2'
			align="justify"> <b>Despacho Longo Diferente</b><br> Ao
				fazer um despacho longo, o usuário vê a tela para edição do despacho
				como documento filho, um expediente à parte. Quando este é
				finalizado e assinado, ocorre uma juntada automática ao pai.</font></td>
	</tr>
	<tr>
		<td style="padding-top: 7; padding-bottom: 7"><font size='2'
			align="justify"> <b>Substituição Mais Fácil</b><br> Para
				mudar de perfil, basta passar o mouse sobre o seu nome, no rodapé, e
				selecionar a pessoa ou lotação desejada.</font></td>
	</tr>
	<tr>
		<td style="padding-top: 7; padding-bottom: 7"><font size='2'
	...
	<tr>
		<td style="padding-top: 7; padding-bottom: 7"><font size='2'
			align="justify"> <b>Relação de Paternidade Entre
				...
				um expediente. Quando assinado, um documento filho é automaticamente
				juntado ao pai. É possivel também, na criação de um expediente,

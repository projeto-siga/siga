...
<ul id="imenus0">
	...
	<ul style="">
		...
		<c:if test="${empty pagina_de_erro}">
			...
			<li><a href="#"> <span class="imea imeas"><span></span></span>Módulos</a>
			<div class="imsc">
			...
			--%>
				<li><ww:a href="/siga/substituicao/listar.action">Gerenciar possíveis substitutos</ww:a></li>
			</ul>
			</div>
			</div>
			</li>
			...
			<c:if
				...
				<li><a href="#"> <span class="imea imeas"><span></span></span>Gestão
				de Identidade</a>
				<div class="imsc">
				<div class="imsubc" style="width: 155px; top: -23px; left: 139px;">
				<ul style="">
					...
					<c:if
						...
						<li><ww:a href="/siga/gi/acesso/listar.action">Configurar Permissões</ww:a></li>
					</c:if>
					<c:if
					...
					<c:if
						...
						<li><ww:a href="/siga/gi/servico/acesso.action">Acesso a Serviços</ww:a></li>
					</c:if>
					<c:if
						test="${f:podeUtilizarServicoPorConfiguracao(titular,lotaTitular,'SIGA;GI;REL:Gerar relatórios')}">
						<li><a href="#"> <span class="imea imeas"><span></span></span>Relatórios</a>
						<div class="imsc">
						<div class="imsubc" style="width: 155px; top: -23px; left: 139px;">
						<ul style="">
							<li><ww:a
								href="/siga/gi/relatorio/selecionar_acesso_servico.action">Acesso aos Serviços</ww:a></li>
							<li><ww:a
								href="/siga/gi/relatorio/selecionar_permissao_usuario.action">Permissões de Usuário</ww:a></li>
							<li><ww:a
								href="/siga/gi/relatorio/selecionar_alteracao_direitos.action">Alteração de Direitos</ww:a></li>
							<li><ww:a
								href="/siga/gi/relatorio/selecionar_historico_usuario.action">Histórico de Usuário</ww:a></li>
						</ul>
						</div>
						</div>
						</li>
		...
		<c:if test="${f:podeUtilizarServicoPorConfiguracao(titular,lotaTitular,'SIGA:Sistema Integrado de Gestão Administrativa;FE:Ferramentas')}">

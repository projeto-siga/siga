...
public class GcBL {
	...
	public GcMovimentacao movimentar(GcInformacao inf, long idTipo,
		...
		if (idTipo == GcTipoMovimentacao.TIPO_MOVIMENTACAO_ANEXAR_ARQUIVO) {
			...
			if (titulo != null && conteudo != null) {
				...
				// throw new
				// Exception("N�o � permitido salvar uma informa��o com t�tulo, conte�do e classifica��o vazios.");
	...
	/**
	 * Calcula quais as marcas cada informa��o ter� com base nas
	 * movimenta��es que foram feitas na informacao.
	 * 
	 * @param inf
	 */

...
public class SrSolicitacaoListaVO {
    ...
    public List<ColunasVO> gerarColunasSolicitacao(boolean telaDeListas, boolean podeRemover, boolean podePriorizar) {
        ...
        if (telaDeListas) {
            ...
            colunasVO.add(new ColunasVO("Lota��o", "lotaAtendenteFormatada", GT_CELULA_NOWRAP_SOLICITACAO_DADOS));
            colunasVO.add(new ColunasVO("�ltima Movimenta��o", ULTIMA_MOVIMENTACAOFORMATADA, GT_CELULA_NOWRAP_SOLICITACAO_DADOS));
            ...
            colunasVO.addAll(getColunasEmComum());
            colunasVO.add(new ColunasVO("Situa��o", "marcadoresEmHtml", GT_CELULA_NOWRAP_SOLICITACAO_DADOS));
            colunasVO.add(new ColunasVO("ښltimo Andamento", ULTIMA_MOVIMENTACAOFORMATADA, GT_CELULA_NOWRAP_SOLICITACAO_DADOS));
    ...
    public List<ColunasVO> gerarColunasDetalhamentoSolicitacao(boolean telaDeListas) {
        ...
        colunasDetalhamentoSolicitacao.add(new ColunasVO("Situa��o", "marcadoresEmHtmlDetalhes"));
        colunasDetalhamentoSolicitacao.add(new ColunasVO("�ltima Movimenta��o", ULTIMA_MOVIMENTACAOFORMATADA));

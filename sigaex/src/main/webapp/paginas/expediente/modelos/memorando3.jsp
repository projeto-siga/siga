...
<mod:modelo>
	<mod:entrevista>
		<c:if test="${empty esconderTexto}">
			<mod:grupo titulo="Texto a ser inserido no corpo do memorando">
				<mod:grupo>
					<mod:editor3 titulo="" var="texto_memorando" />
				</mod:grupo>
			</mod:grupo>
	...
	<mod:documento>
		...
		<head>
		<link rel="StyleSheet" href="contextpath/XStandard/format.css" type="text/css">
		<style type="text/css">
@page {
	margin-left: 3cm;
	margin-right: 2cm;
	...
	margin-bottom: 2cm;
		...
		<c:import url="/paginas/expediente/modelos/inc_cabecalhoEsquerdaPrimeiraPagina3.jsp" />
		</td></tr>
			<tr bgcolor="#FFFFFF">
				<td width="100%">
					<table width="100%">
		...
		<c:import url="/paginas/expediente/modelos/inc_rodapeClassificacaoDocumental3.jsp" />
		FIM PRIMEIRO RODAPE -->

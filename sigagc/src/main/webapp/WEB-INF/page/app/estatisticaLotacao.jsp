								...
								<c:forEach var="i" items="${listaMaisRecentes}">
									<tr class="gt-td">
										<td width="45%"><h4 class="gt-categories-link">
												<a href="${linkTo[AppController].exibir[i.sigla]}">${i.arq.titulo}
											</h4> </a></td>
								...
								<c:forEach items="${listaPrincipaisAutores}" var="p">
									<tr>
										...
										<td style="width: 20%; text-align: right;"><a
											href="${linkTo[AppController].listar}?filtro.autor=${p[1]}&filtro.lotacao=${p[3]}&filtro.situacao=36&filtro.pesquisa=true">${p[4]}</a></td>
									</tr>
								</c:forEach>
							</tbody>
						</table>

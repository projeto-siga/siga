 ...
 *         &lt;element name="MATRRECEBDOR" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
...
@XmlRootElement(name = "TIncluiProcesso_WS")
public class TIncluiProcessoWS {
    ...
    @XmlElement(name = "MATRRECEBDOR")
    protected String matrrecebdor;
    ...
    /**
     * Obt�m o valor da propriedade matrrecebdor.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Define o valor da propriedade matrrecebdor.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setMATRRECEBDOR(String value) {
        this.matrrecebdor = value;
    }

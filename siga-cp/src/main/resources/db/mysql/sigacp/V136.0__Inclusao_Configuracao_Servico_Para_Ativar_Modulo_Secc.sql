...
Insert into corporativo.cp_servico (sigla_servico, desc_servico, id_servico_pai, id_tp_servico) 
   SELECT  'SIGA-SECC','Módulo serviço de compra e contratação',  max(id_servico) , '2'
   FROM corporativo.cp_servico 
   WHERE sigla_servico = 'SIGA-SECC'   
   ON DUPLICATE KEY UPDATE sigla_servico = 'SIGA-SECC'; 
...
VALUES (current_timestamp(), '2', '200', (SELECT id_servico FROM corporativo.cp_servico WHERE sigla_servico = 'SIGA-SECC'), '1'); 
...
public class ExPodeAcessarCancelado extends CompositeExpressionSupport {
	 ...
	 * por parâmetro. Considera se o documento está cancelado (não estando
	 * cancelado, retorna verdadeiro) e se <i>uma das</i> seguintes condições é
	 * satisfeita:
	 * <ul>
	 ...
	 * @return
	 */
	public ExPodeAcessarCancelado(ExMobil mob, DpPessoa titular, DpLotacao lotaTitular) {
		this.mob = mob;
	...
	protected Expression create() {
		return And.of(new CpNaoENulo(mob, mob != null ? mob.getSigla() : "via ou volume"),
				Or.of(Not.of(new ExEstaCancelado(mob.doc())),

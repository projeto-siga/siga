...
public enum CpServicosNotificacaoPorEmail {
	...
	DOCMARC ("Notificações de marcadores destinados a minha unidade ou usuário", SIGACEMAIL.getSigla() + "-" + "DOCMARC", SIGACEMAIL.getChave() + ";" + "DOCMARC:Notificações de marcadores destinados a minha unidade ou usuário", true),

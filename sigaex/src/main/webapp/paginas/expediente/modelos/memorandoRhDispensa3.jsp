		...
		<c:forEach var="i"
			...
			<table width="100%" border="1" cellpadding="2" cellspacing="1"
				...
				<tr bgcolor="#BEBEBE">
					...
					<td bgcolor="#BEBEBE" align="center" width="12%"><b>Matrícula</b></td>
					<td bgcolor="#BEBEBE" align="center" width="33%"><b>Cargo</b></td>
					<td bgcolor="#BEBEBE" align="center" width="25%"><b>Nível/Classe/Padrão</b></td>
				</tr>
				<tr>					
					<td bgcolor="#FFFFFF" align="center" width="30%">${pes.descricao}</td>
					<td bgcolor="#FFFFFF" align="center" width="12%">${pes.sigla}</td>
					<td bgcolor="#FFFFFF" align="center" width="33%">${pes.cargo.nomeCargo}</td>
					<td bgcolor="#FFFFFF" align="center" width="25%">${pes.padraoReferenciaInvertido}</td>
				</tr>
			</table>
			...
			<table width="100%" border="1" cellpadding="2" cellspacing="1"
				bgcolor="#000000">
				<tr>					
					<td bgcolor="#BEBEBE" align="center" width="40%"><b>Lotação</b></td>
					<td bgcolor="#BEBEBE" align="center" width="30%"><b>Função Comissionada</b></td>
				...
				<tr>
					...
					<c:set var="portaria" value="Publicação da Portaria" />

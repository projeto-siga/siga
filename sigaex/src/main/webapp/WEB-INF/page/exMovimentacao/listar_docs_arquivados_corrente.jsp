...
<siga:pagina titulo="Documentos arquivados" popup="true">

    <div class="container-fluid">
        <div class="card bg-light mb-3">
            <div class="card-header">
                <h5>Documentos arquivados</h5>
            </div>
        </div>
        ...
        <c:if test="${not empty movsDocumentosNaoArquivadosCorrente}">
            <div class="card bg-light mb-3">
                <div class="card-header">
                    <h5>Documentos n&atilde;o arquivados</h5>
                </div>
                ...
                <div class="card-body">
                    <table class="table table-hover table-striped">
                        ...
                        <c:forEach var="mov" items="${movsDocumentosNaoArquivadosCorrente}">
                            <tr>
                                <td align="center">
        ...
        <c:if test="${not empty mobisDocumentosArquivadosCorrente}">
            <div class="card bg-light mb-3">
                <div class="card-header">
                    <h5>Documentos arquivados com sucesso</h5>
                </div>

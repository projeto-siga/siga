...
public interface IExApiV1 {
    ...
    public interface IClassificacoesAplicarMascaraGet extends ISwaggerMethod {
        public static class Request implements ISwaggerRequest {
            public String sigla;
        }
    ...
    public interface IDocumentosSiglaTramitarEmParaleloPost extends ISwaggerMethod {
        public static class Request implements ISwaggerRequest {
            public String sigla;
            public String lotacao;
            public String matricula;
    ...
    public interface IDocumentosSiglaNotificarPost extends ISwaggerMethod {
        public static class Request implements ISwaggerRequest {
            public String sigla;
            public String lotacao;
            public String matricula;
    ...
    public interface IDocumentosSiglaConcluirPost extends ISwaggerMethod {
        public static class Request implements ISwaggerRequest {
            public String sigla;
        }

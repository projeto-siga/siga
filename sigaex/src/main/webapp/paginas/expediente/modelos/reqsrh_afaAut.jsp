...
<mod:modelo>
	...
	<mod:grupo titulo=" ">	
	 ...
	 <mod:grupo titulo="Documento Anexado:">
		 ...
		 <mod:radio titulo="Xerox de Certidão de Óbito" var="periodo" valor="4" reler="sim" />
		 ...
		 <c:if test="${valorperiodo == 1}"><span style="color:red"><br><b>&nbsp; FAVOR USAR CLASSIFICAÇÃO 20.06.02.02</b></span><br></c:if>
		 <c:if test="${valorperiodo == 2}"><span style="color:red"><br><b>&nbsp; FAVOR USAR CLASSIFICAÇÃO 20.06.02.05</b></span><br></c:if> 
		 <c:if test="${valorperiodo == 3}"><span style="color:red"><br><b>&nbsp; FAVOR USAR CLASSIFICAÇÃO 20.06.02.01</b></span><br></c:if> 
		 <c:if test="${valorperiodo == 4}"><span style="color:red"><br><b>&nbsp; FAVOR USAR CLASSIFICAÇÃO 20.06.02.03</b></span><br></c:if>      
...
@page {
	...
	margin-bottom: 1cm;
		...
		<p style="text-align: center;font-weight:bold;font-size:11pt;"><center><br><br><b> ${ilustrissima} DA SECRETARIA DE RECURSOS HUMANOS</center></b></p>
				<br><br><br><br>		
			${doc.subscritor.descricao}, ${doc.subscritor.cargo.nomeCargo}, matrícula ${doc.subscritor.matricula}, ${opt}, ${lotc} ${acgr} ${doc.subscritor.lotacao.descricao}, ramal ${ramal}, vem à presença  

...
<c:choose>
	<c:when test="${siga_cliente == 'GOVSP'}">
		...
		<link rel="stylesheet" href="/siga/css/style_siga_govsp?v=1647962650.css" type="text/css" media="screen, projection">
...
<link rel="stylesheet" href="/siga/css/style_siga?v=1647962650.css" type="text/css" media="screen, projection">

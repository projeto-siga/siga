...
<c:set var="texto1"><fmt:message key="tela.autenticar.texto1" /></c:set>
<c:set var="texto2"><fmt:message key="tela.autenticar.texto2" /></c:set>
<c:set var="texto3"><fmt:message key="tela.autenticar.texto3" /></c:set>
<c:set var="texto4"><fmt:message key="tela.autenticar.texto4" /></c:set>

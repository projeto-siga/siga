									...
									<c:if test="${(not mov.cancelada)}">
										<tr class="${mov.classe} ${mov.disabled}">
											...
											<td>${mov.descricao}
												...
												<input type="hidden" name="ad_id_${mov.idMov}" value="${titular.cpfPessoa}__${fn:replace(mov.mov.referencia, ':', '_')}" />
		...
		<div class="gt-content clearfix">			
			...
			<div id="dados-assinatura" style="display: none">
				...
				<tags:assinatura_botoes
					...
					autenticarComSenha="${f:podeAutenticarlComSenha(titular,lotaTitular,mob)}" />

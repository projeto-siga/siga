...
<mod:modelo salvarViaAjax="N" acaoGravar="gravarBI" acaoExcluir="excluirBI" acaoCancelar="refazerBI" acaoFinalizar="finalizarBI">
	<mod:entrevista>
		...
		<mod:grupo>
			<mod:texto titulo="Vice-Presidente" var="nmVicePresidente" valor="Desembargador Federal Raldênio Bonifacio Costa" largura="90" />
		</mod:grupo>
		<mod:grupo>
			<mod:texto titulo="Corregedor Regional" var="nmCorregedorRegional" valor="Desembargador Federal André Fontes" largura="90" />
		</mod:grupo>
		<mod:grupo>
	...
	<mod:documento>
		...
		<c:set var="hBIE"
			value="${f:obterHierarquizadorBIETRF2(lotaTitular.orgaoUsuario, doc)}"></c:set>

...
public class WfTarefaDocAguardarAuxiliar extends
	...
	public TaskResult execute(WfDefinicaoDeTarefa td, WfProcedimento pi, Engine engine) throws Exception {
		if (Utils.empty(pi.getPrincipal()) || Service.getExService().isAuxiliarIncluso(pi.getPrincipal(), pi.getEventoData() != null ? pi.getEventoData() : new Date()))

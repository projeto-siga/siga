				...
				<form action="carga" method="POST" enctype="multipart/form-data" class="form">
					...
					<table class="gt-form-table">
						...
						<tr>
							<td  colspan="2">
								<dl>
								  <dt>&#149;&#160;Somente esta liberada a carga de planilhas no formato Excel: "XLSX, CSV e TXT"</dt>
						...
						<tr>
							<td colspan="2"><label>Selecione o arquivo contendo a planilha com dados:&nbsp;&nbsp;&nbsp;</label><input type="file" name="arquivo" accept=".xlsx,.txt,.csv" /></td>

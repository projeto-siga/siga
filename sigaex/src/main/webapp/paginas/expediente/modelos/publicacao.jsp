...
<mod:modelo>
	...
	<mod:entrevista>
		<mod:grupo titulo="Dados referenciais">
			<mod:grupo>
				<mod:lotacao titulo="Lotação de Origem" var="lotOrigem" reler="sim"/>
			</mod:grupo>
			<mod:grupo>
			...
			<tr bgcolor="#FFFFFF">
				<td width="100%">
					<table width="100%">
						...
						<tr><td>&nbsp;</td></tr>
						<tr>
							<td align="left"><mod:letra tamanho="${tl}"><p>Lotação de Origem: ${requestScope['lotOrigem_lotacaoSel.descricao']}</p></mod:letra></td>
						</tr>
					</table>
				</td>
			</tr>

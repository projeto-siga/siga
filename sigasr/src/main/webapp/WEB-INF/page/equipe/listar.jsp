...
<script type="text/javascript">
	...
	equipeService.atualizarModalEquipe = function(equipe) {
		...
		// Caso seja cadastro, atualiza os dados da Lota��o
		else {
			...
			// chama o editar para popular o campo da lota��o
	...
	equipeService.carregarExcecoes = function(equipe) {
		...
		if (equipe.excecaoHorarioSet) {
			// cria a lista de Exce��es de hor�rio, e adiciona na tela
	...
	equipeService.carregarDesignacoes = function(id) {
        $.ajax({
        	...
        	error: function(error) {
            	alert("N�o foi poss�vel carregar as Designa��es desta Equipe.");
        	}
       	});
    }
</script>
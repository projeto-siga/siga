...
<mod:modelo urlBase="/paginas/expediente/modelos/requerimento_rh.jsp">
	...
	<mod:valor var="texto_requerimento">						
		...
		${doc.subscritor.descricao}, ${doc.subscritor.cargo.nomeCargo}, ${doc.subscritor.padraoReferenciaInvertido}, removido de Ofício e no interesse da Administração, do(a) ${sedeOrigem} para o(a) ${sedeDestino}, com efeitos a contar de ${dataVigencia}, vem requerer a Vossa Excelência a concessão 

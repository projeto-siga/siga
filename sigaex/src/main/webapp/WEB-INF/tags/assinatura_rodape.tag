...
<Applet Code="bluecrystal.applet.sign.SignApplet.class"
	archive="/sigaex/bluc/bluc_p11_1.jar" width=1 Height=1 id="signer">
	<PARAM name="module"
...
<Applet Code="bluecrystal.applet.capi.SignApplet.class"
		archive="/sigaex/bluc/bluc_capi_2.jar,/sigacd/jna-platform-4.1.0_2.jar,/sigacd/jna-4.1.0_2.jar" width=1

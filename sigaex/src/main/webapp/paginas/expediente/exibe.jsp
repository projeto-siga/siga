			...
			<table class="gt-table mov">
				<thead>
					<tr>
						...
						<th rowspan="2" style="padding: 5px 5px;">Lota̤̣o</th>
						<th rowspan="2" style="padding: 5px 5px;">Evento</th>
						<th rowspan="2" style="padding: 5px 5px;">Descri̤̣o</th>
					</tr>
				</thead>
...
<div class="gt-bd clearfix" id="svgRelacaoDocs" style="display: none; overflow-y: scroll;">
		...
		<p style="font-weight: bold">Clique sobre a imagem com o boṭo esquerdo para ampliar ou com o direito para reduzir.</p>

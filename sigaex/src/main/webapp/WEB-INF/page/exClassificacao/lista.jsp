...
<script type="text/javascript">
	...
	<div class="container-fluid">
					...
					<tbody class="table-bordered align-middle text-center">
						<c:forEach items="${classificacaoVigente}" var="cla">
							...
							<tr >
								...
								<td rowspan="${numVias + viasDefault}" class="align-middle"><a title="${cla.descricao}" href="editar?codificacao=${cla.codificacao}&acao=editar_classificacao">${cla.codificacao}</a></td>
								<td rowspan="${numVias + viasDefault}" class="align-middle text-left">${cla.descrClassificacao}</td>
								<c:choose>
		...
		<form id="frmNovaClassif" action="editar" method="get">
			<button type="button" id="btNovaClassif" class="btn btn-primary" style="cursor: pointer;" onclick="javascript:novaClassificacao()" ><u>N</u>ova Classificação</button>

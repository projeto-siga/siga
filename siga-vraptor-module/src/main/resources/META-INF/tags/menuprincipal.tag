...
<li class="nav-item dropdown"><a class="nav-link dropdown-toggle"
	...
	aria-haspopup="true" aria-expanded="false"> SIGA </a>
	<div class="dropdown-menu" aria-labelledby="navbarDropdown">
		<a class="dropdown-item" href="/siga/app/principal">Página Inicial</a>
		<div class="dropdown-divider"></div>
		<a class="dropdown-item" href="/siga/app/principal">Módulos</a>
	</div></li>


<c:if test="${false}">

	<c:if test="${false and empty pagina_de_erro}">
		<c:if
			test="${f:podeUtilizarServicoPorConfiguracao(titular,lotaTitular,'SIGA;DOC:Módulo de Documentos')}">
			<li><a href="/sigaex/app/expediente/doc/listar?primeiraVez=sim">Documentos</a>
			</li>
		</c:if>

		<c:if
			test="${f:podeUtilizarServicoPorConfiguracao(titular,lotaTitular,'SIGA;WF:Módulo de Workflow')}">
			<li><a href="/sigawf/app/resumo">Workflow</a></li>
		</c:if>
		...
		<c:if
			...
			<li><a href="/sigagc/app/estatisticaGeral">Gestão de
					Conhecimento</a></li>
		</c:if>
			...
			<li><a href="#">Pessoas</a>
				<ul>
					...
					<c:if
						...
						<li><a href="${f:getURLSistema('siga.sgp.bdp')}">Banco de
								Permutas</a></li>
					</c:if>
					<c:if
					...
					<c:if
						...
						<li><a href="${f:getURLSistema('siga.sgp.dcn')}">Docência
								de Magistrados</a></li>
					</c:if>
					<c:if
						test="${f:podeUtilizarServicoPorConfiguracao(titular,lotaTitular,'SIGA;LOT: Módulo de Lotação')}">
						<li><a href="${f:getURLSistema('siga.sgp.lot')}">Lotação</a></li>
					</c:if>
					<c:if
			...
			<li><a href="#">Agendas</a>
				<ul>
					<c:if
						...
						<li><a href="/sigapp/">Perícias Médicas</a></li>
					</c:if>
				</ul></li>
		</c:if>
		...
		<li><a href="#">Administração</a>
			<ul>
				<li><a href="/siga/app/usuario/trocar_senha">Trocar senha</a></li>
				<%--
				...
				<c:choose>
					<c:when
						...
						<c:if
							...
							<li><a href="${serverAndPort}/siga/app/substituicao/listar">Gerenciar
			...
			<li><a href="#">Gestão de Identidade</a>
				<ul>
					<c:if
						...
						<li><a href="/siga/app/gi/identidade/listar">Identidade</a></li>
					</c:if>
					<c:if
						test="${f:podeUtilizarServicoPorConfiguracao(titular,lotaTitular,'SIGA;GI;PERMISSAO:Gerenciar permissões')}">
						<li><a href="/siga/app/gi/acesso/listar">Configurar
								Permissões</a></li>
					</c:if>
					<c:if
					...
					<c:if
						...
						<li><a href="/siga/app/gi/perfilJEE/listar">Perfil de
								Acesso do JEE</a></li>
					</c:if>
					<c:if
					...
					<c:if
						...
						<li><a href="/siga/app/gi/servico/editar">Acesso a
								Serviços</a></li>
					</c:if>
					<c:if
 ...
 --%>
	...
	<li><a id="apostilaSiga" href="/siga/arquivos/apostila_sigaex.pdf"
		target="_blank">Apostila SIGA-Doc</a></li>

	<li><a href="/siga/?GLO=true">Logoff</a></li>

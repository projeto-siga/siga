...
<c:set var="para" value="sepag" scope="request" />
<mod:modelo urlBase="/paginas/expediente/modelos/requerimento_rh.jsp">
	<mod:entrevista>
		...
		<mod:grupo titulo="">
			...
			<mod:texto obrigatorio="Sim" titulo="Agência" var="agencia"/>
	...
	<mod:documento>		
		...
		vem requerer a Vossa Senhoria declaração de margem para fins de refinanciamento / compra de dívida na seguinte Instituição Financeira: ${instituicaoFinanceiro}, agência ${agencia}.
		</p>

...
<link rel="stylesheet" href="/siga/bootstrap/css/bootstrap.min.css?v=4.5.3"	type="text/css" media="screen, projection" />
...
<c:set var="siga_version"  scope="request" value="9.0.18.0" />

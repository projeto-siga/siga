...
import br.gov.jfrj.siga.ex.api.v1.IExApiV1.QuadroGetRequest;
import br.gov.jfrj.siga.ex.api.v1.IExApiV1.QuadroGetResponse;
...
public class QuadroGet implements IQuadroGet {
	...
	public void run(QuadroGetRequest req, QuadroGetResponse resp) throws Exception {
		try (ApiContext ctx = new ApiContext(false, true)) {
			...
			List<Object[]> listEstados = ExDao.getInstance().consultarPaginaInicial(ctx.getTitular(),
					ctx.getLotaTitular(), idTpFormaDoc);

...
@page {
	...
	margin-bottom: 2 cm;
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
		    <tr><td width="100%" align="center" style=" font: bold; font-size: 14pt"><b>PROCESSO DE VITALICIAMENTO</b></td></tr>
			<tr>
			    <td>
					<table border="0" align="center" bgcolor="#ffffff" width="100%">
						<tr>
							<td width="20%" bgcolor="white"></td>
							<br><br><td><c:import url="/paginas/expediente/modelos/inc_cabecalhoCentralizadoPrimeiraPagina.jsp" /></td>
							<td width="20%" bgcolor="white"></td>
						</tr>

...
<mod:modelo>
	<mod:entrevista>			
		...
		<mod:grupo titulo="10. Os uniformes estão em boas condições?">
			<mod:radio titulo="Sim." var="boaCondUnif" valor="1" marcado="Sim"
						reler="ajax" idAjax="boaCondUnifAjax" />
			<mod:grupo largura="7">
				<mod:radio titulo="Não." var="boaCondUnif" valor="2" reler="ajax"
		...
		<mod:grupo titulo="11. Os contracheques apresentaram divergências ou irregularidades?">	
			<mod:radio titulo="Sim." var="irregContCheq" valor="1" marcado="Sim"
						reler="ajax" idAjax="irregContCheqAjax" />		
			<mod:grupo largura="7">
				<mod:radio titulo="Não." var="irregContCheq" valor="2" reler="ajax"
		...
		<mod:grupo titulo="12. Os funcionários prestaram os serviços em conformidade com a especificação?">		

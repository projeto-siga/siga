		...
		<p class="gt-table-action-list">
			<siga:links inline="${true}">
				<a name="inicio" style="float: right; padding-right: 5pt;" class="once" href="#final"> 
					<img src="/siga/css/famfamfam/icons/arrow_down.png" style="margin-right: 5px;"> Ir para o Final
				</a>
				...
				<input type="radio" id="radioPDF" name="formato" value="pdf" accesskey="p" onclick="exibir(htmlAtual,pdfAtual,'');">
					...
					<c:if test="${siga_cliente == 'GOVSP'}">
						<a id="pdflink" accesskey="a"> <u>P</u>DF&nbsp;&nbsp; </a>  
					</c:if>
				</input>
				<input type="radio" id="radioPDFSemMarcas" name="formato" accesskey="s" value="pdfsemmarcas" onclick="exibir(htmlAtual,pdfAtual,'semmarcas/');">
					...
					<c:if test="${siga_cliente == 'GOVSP'}">
						<a id="pdfsemmarcaslink" accesskey="a"> PDF <u>s</u>em marcas&nbsp;&nbsp; </a>  
					</c:if>
				</input>
...
<div id="main" class="gt-bd clearfix" style="padding-top: 0px; margin-top: 0px;">
...
<!-- 				<COL width="55%" />
	...
	<div id="right-col" class="gt-right-col">
		...
		<div style="margin: 0px; padding: 0px; border: 0px; clear: both;">
			<p class="gt-table-action-list">
				<a style="float: right; padding-right: 5pt; padding-top: 5pt;" name="final" href="#inicio">
					<img src="/siga/css/famfamfam/icons/arrow_up.png" style="margin-right: 5px;">Ir para o Topo
				</a>
			</p>
		</div>
	</div>

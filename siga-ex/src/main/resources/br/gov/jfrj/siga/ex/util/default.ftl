                            ...
                            <script type="text/javascript">
								...
								// @license Copyright © 2013 Stuart Sillitoe <stuart@vericode.co.uk>
 								...
 								CKEDITOR.config.strinsert_strings = [
									...
									{'name': 'Item: Quantidade', 'value': '$' + "{ref.modelo('Comprasnet').form.itemquant1NÚMERO_DO_ITEM}"},
									...
									{'name': 'Item: Unidade de medida', 'value': '$' + "{ref.modelo('Comprasnet').form.unidademedida1NÚMERO_DO_ITEM}"},

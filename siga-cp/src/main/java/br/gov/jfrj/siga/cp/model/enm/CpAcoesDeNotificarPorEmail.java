...
public enum CpAcoesDeNotificarPorEmail {
	...
	RESPONS_ASSINATURA (1711, "ResponsÃ¡vel pela assinatura", 1711L),
	CONSSIGNATARIO (1712, "Conssignatario", 1712L),
	SUBSTITUICAO (1713, "SubstituiÃ§Ã£o", 1713L),
	DOC_TRAMIT_PARA_MEU_USU (1714, "Tramitar para o meu usuÃ¡rio", 1714L),
	DOC_TRAMIT_PARA_M_UNIDADE (1715, "Tramitar para minha unidade", 1715L),
	TRAMIT_DOC_MARCADOS (1716, "TramitaÃ§Ã£o de documentos marcados", 1716L),
	ALTERACAO_EMAIL (1717, "AlteraÃ§Ã£o de email", 1717L),
	DOC_MARCADORES (1718, "Documentos de marcadores", 1718L),
	CADASTRO_USUARIO (1719, "Cadastro de novo usuÃ¡rio", 1719L);

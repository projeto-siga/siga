...
<div class="modal fade" id="prosseguirSobrestarModal" tabindex="-1"
	role="dialog" aria-labelledby="anotarModalLabel" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
			...
			<div class="modal-body" style="padding-top: 70px; padding-bottom: 60px;">
					...
					<div class="form-group">
						<div class="form-group">
							<p>Você deseja SOBRESTAR este documento?</p>
						</div>
					</div>
			</div>
			<div class="modal-footer">
				<button id="btnMarcarCancelar" type="button" class="btn btn-danger" data-dismiss="modal">Não</button>
				<a href="${linkTo[ExMovimentacaoController].sobrestarGravar()}?sigla=${mob.sigla}" 
					style="background: #34BF1F; border-radius: 5px; width: 52px; height: 40px; color: white; text-align: center; padding-top: 8px;">Sim</a>
			</div>
		</div>
	</div>
</div>

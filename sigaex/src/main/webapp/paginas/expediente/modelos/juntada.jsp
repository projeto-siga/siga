...
<mod:modelo>
	<mod:entrevista>
		<c:if test="${empty esconderTexto}">
			<mod:grupo titulo="Texto a ser inserido no corpo da juntada">
				<mod:grupo>
					<mod:editor titulo="" var="texto_juntada" />
				</mod:grupo>
			</mod:grupo>
...
@page {
		...
		<c:import url="/paginas/expediente/modelos/inc_cabecalhoEsquerdaPrimeiraPagina.jsp" />
			...
			<tr bgcolor="#FFFFFF">
				<td width="100%">
					<table width="100%">
						<tr>
							<td align="left"><p style="font-family:Arial;font-weight:bold;font-size:11pt;"></br></br></br>JUNTADA N&ordm; ${doc.codigo}</p></td>
						</tr>
					</table>
				</td>
			</tr>
	...
	<br/>
			<span style="font-size: ${tl}"> ${texto_juntada} </span>
			<p style="align: justify; TEXT-INDENT: 2 cm">Do que, para constar, lavro este termo.</p>
			<p>&nbsp;</p>

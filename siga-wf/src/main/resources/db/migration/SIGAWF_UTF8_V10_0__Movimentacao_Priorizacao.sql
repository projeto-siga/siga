...
ALTER TABLE sigawf.wf_movimentacao MODIFY (MOVI_TP_DESIGNACAO VARCHAR(12) NULL);
...
ALTER TABLE sigawf.wf_procedimento MODIFY (PROC_TP_PRIORIDADE VARCHAR(12) NULL);
COMMENT ON COLUMN sigawf.wf_procedimento.PROC_TP_PRIORIDADE IS 'Prioridade do procedimento';
ALTER TABLE sigawf.wf_procedimento MODIFY (PROC_ST_CORRENTE VARCHAR(12) NULL);
COMMENT ON COLUMN sigawf.wf_procedimento.PROC_ST_CORRENTE IS 'Status atual do procedimento';
ALTER TABLE sigawf.wf_procedimento MODIFY (PROC_CD_PRINCIPAL VARCHAR(32) NULL);

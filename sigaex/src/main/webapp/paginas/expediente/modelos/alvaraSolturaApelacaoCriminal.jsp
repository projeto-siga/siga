...
<mod:modelo>
	...
	<mod:documento>
		...
		<p align="justify"><!-- INICIO FECHO -->${vocativo} <b>${doc.subscritor.descricao}</b>, ${nomeCargo} ${nomeOrgao}, nos autos da <b><i>APELAÇÃO CRIMINAL</i> N&ordm; ${apelacao_criminal} (Proc. Orig. n&ordm; ${numProcesso1} - ${orig_processo1} e ${numProcesso2} - ${orig_processo2})</b>, em que figuram, como APELANTE <b>${apelante }</b>, e, como APELADO <b>${apelado }</b> <!-- FIM FECHO --><br />
		<br/>
		</p>
		<p align="right"><b><u>MANDA</u></b>
					
				<br><div align="justify" >Ao SUPERINTENDENTE DA POLÍCIA FEDERAL, ou quem suas vezes fizer, ao lhe ser este apresentado, indo por mim assinado, que ponha em liberdade, se "por al" não estiver preso, <font size="3"><b>${nm_beneficiario }</b></font>, ${texto}, nos autos da <i>APELAÇÃO CRIMINAL</i> N&ordm; <b>${apelação_criminal} (Proc. Orig. n&ordm; ${numProcesso1} - ${orig_processo1} e ${numProcesso2} - ${orig_processo2} ), <u>ficando ressalvado que esta decisão de soltura do preso é somente referente a este feito.</u></b>
				<br><b><u>${texto_f}.</u></b></br></div></p>
						
		</c:if>

		<c:if test="${quantidadeProcessos mod 2 == 1}">
		<p align="justify"><!-- INICIO FECHO -->${vocativo} <b>${doc.subscritor.descricao}</b>, ${nomeCargo} ${nomeOrgao}, nos autos da <b>APELAÇÃO CRIMINAL N&ordm; ${apelacao_criminal} (Proc. Orig. n&ordm; ${numProcesso1} - ${orig_processo1})</b>, em que figuram, como APELANTE <b>${apelante }</b>, e, como APELADO <b>${apelado }</b> <!-- FIM FECHO --><br />
		<br />
		</p>
		<p align="right"><b><u>MANDA</u></b>

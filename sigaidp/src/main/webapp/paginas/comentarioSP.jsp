...
<p align="justify"><font style="font-family: Calibri; font-size: 20px; line-height: 27px"><a href="${f:resource('siga.ex.manual.url')}" target="_blank">Clique aqui para acessar o manual de uso.</a></font></p>  
		</td>
	</tr>
</table>
	...
	<footer class="text-center text-white align-middle" style="background-color: #20313b;">
		<div class="container">						
			...
			<div class="text-right text-white">
				<b>SIGA.doc</b> 8.0.5-test <c:if test="${siga.versao != ''}">${siga.versao}</c:if> <span style="white-space:nowrap;"><i class="fa fa-code"></i> Desenvolvido por Prodesp e TRF2 </span>				
			</div>
		</div>
	</footer>

...
public class Cards implements java.io.Serializable, Sincronizavel {
	...
	public Cards(String staffNumber, String cardNumber, String name,
			...
			String positionCode, char cardType) {
	...
	public Cards(String staffNumber, String cardNumber, String name,
			...
			String positionCode, char cardType, String misc, String assignTo,
	...
	public Long getId() {
		...
		if(idSemEspacos.length() > 5)
			return Long.valueOf(idSemEspacos.substring(idSemEspacos.length() - 5));
		else

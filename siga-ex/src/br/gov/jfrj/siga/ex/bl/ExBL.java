...
public class ExBL extends CpBL {
			...
			if (mob.getExMovimentacaoSet() != null) {
				...
				for (ExMovimentacao mov : mob.getExMovimentacaoSet()) {
					...
					if (t == ExTipoMovimentacao.TIPO_MOVIMENTACAO_VINCULACAO_PAPEL) {
						...
						/* não é possível usar ExMovimentacao.isAssinada() pois não há tempo habil
						 * no BD de efetivar a inclusao de movimentacao de assinatura de movimentção
						 */
		...
		try {
			...
			for (ExMobil m : set) {
				final ExMovimentacao mov = criarNovaMovimentacao(
						...
						cadastrante, lotaCadastrante, m, dtMov, subscritor, null,
						null, null, dt);
				gravarMovimentacao(mov);
	...
	public String assinarDocumento(final DpPessoa cadastrante,
		...
		try {
			...
			s = client.validarAssinaturaPKCS7(MessageDigest.getInstance("SHA1")
		...
		try {
			...
			for (ExMobil m : set) {
				...
				final ExMovimentacao mov = criarNovaMovimentacao(
						...
						cadastrante, lotaCadastrante, m, null, null, null, null,
						null, null);
		...
		try {
			...
			if (mob.getNumSequencia() > 1) {
				...
				ExMovimentacao movApenso = criarNovaMovimentacao(
						...
						cadastrante, lotaCadastrante, mobApenso, null, null, null,
						null, null, null);
		...
		try {
			...
			for (ExMobil m : set) {
				final ExMovimentacao mov = criarNovaMovimentacao(
						...
						cadastrante, lotaCadastrante, m, dtMov, cadastrante, null,
						null, null, null);
	...
	public void registrarAcessoReservado(DpPessoa cadastrante,
		...
		try {
			...
			final ExMovimentacao mov = criarNovaMovimentacao(
					...
					cadastrante, lotaCadastrante, mob, null, null, null, null, null,
					null);
	...
	public void anotar(final DpPessoa cadastrante,
		...
		try {
			...
			final ExMovimentacao mov = criarNovaMovimentacao(
					...
					lotaCadastrante, mob, dtMov, subscritor, null, titular, null,
					dtMov);
	...
	public void vincularPapel(final DpPessoa cadastrante,
		...
		try {
			...
			final ExMovimentacao mov = criarNovaMovimentacao(
					...
					cadastrante, lotaCadastrante, mob, dtMov, responsavel, lotaResponsavel,
					titular, null, dtMov);

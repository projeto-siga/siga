		...
		<div class="container-fluid">
			<div class="card bg-light mb-3">
				<div class="card-header">
					<h5>N&atilde;o Foi Poss&iacute;vel Completar a
						Opera&ccedil;&atilde;o (${pageContext.request.serverName})</h5>
				</div>
				...
				<div class="card-body">
					...
					<c:if test="${siga_cliente == 'GOVSP'}">
									...
									<div class="form-group">
										<table id="idBasico" class="table">
											<tr>
												...
												<fmt:formatDate var="datahora" value="${now}"
											...
											<tr>
												<td>Servidor:</td>
												<td><c:out value="${thread}" /> / <c:out
														value="${f:resource('ambiente')}" /></td>
											</tr>
											<tr>
												<td>Usuário</td>
												<td><c:out value="${cadastrante.lotacao}" /> / <c:out
														value="${cadastrante.sigla}" /></td>
											</tr>
										</table>
									</div>
								</div>
						...
						<div class="row">
							<div class="col">
								<div class="form-group">
									<div style="display: none; padding: 8pt;" align="left"
										id="stack">

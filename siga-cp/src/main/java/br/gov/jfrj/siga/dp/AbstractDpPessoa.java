...
@NamedQueries({
		...
		@NamedQuery(name = "consultarPessoaAtualPelaInicial", query = "from DpPessoa pes where pes.idPessoaIni = :idPessoaIni and pes.dataFimPessoa is null"),
		...
		@NamedQuery(name = "consultarPorEmailIgualCpfDiferente", query = "select count(pes) from DpPessoa pes where lower(pes.emailPessoa) = lower(:emailPessoa) and pes.cpfPessoa <> :cpf and pes.idPessoaIni <> :idPessoaIni"),

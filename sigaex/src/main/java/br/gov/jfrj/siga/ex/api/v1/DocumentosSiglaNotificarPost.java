...
import br.gov.jfrj.siga.ex.api.v1.IExApiV1.IDocumentosSiglaNotificarPost;
...
@Transacional
public class DocumentosSiglaNotificarPost implements IDocumentosSiglaNotificarPost {
    ...
    private ExTipoDeMovimentacao getTipoMov() {
        return ExTipoDeMovimentacao.NOTIFICACAO;
    }

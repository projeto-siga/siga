...
public class SigaPlayUtil {
	...
	public static String botaoPriorizarSolicitacao() {
		StringBuffer sb = new StringBuffer();
		sb.append("<a class=\"once gt-btn-ativar\" onclick=\"listaService.alterarPosicao(this)\" title=\"Alterar posição\">");
		sb.append("<img src=\"/siga/css/famfamfam/icons/arrow_refresh_small_up_down.png\" style=\"margin-right: 5px;\"></img> </a>");
		sb.append("<a class=\"once gt-btn-ativar\" onclick=\"listaService.alterarPrioridade(this)\" title=\"Alterar prioridade\">");

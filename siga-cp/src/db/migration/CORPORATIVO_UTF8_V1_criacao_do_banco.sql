...
Insert into CORPORATIVO.DP_CARGO (ID_CARGO,NOME_CARGO,ID_ORGAO_USU,DT_FIM_CARGO,DT_INI_CARGO,ID_CARGO_INICIAL,IDE_CARGO,SIGLA_CARGO) values (1,'FUNCIONÁRIO',1,null,to_date('03/08/11','DD/MM/RR'),1,'203','500300');

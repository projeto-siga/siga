...
public class ExMobilVO extends ExVO {
	...
	private void addAcoes(ExMobil mob, DpPessoa titular, DpLotacao lotaTitular) {
		...
		addAcao(AcaoVO.builder().nome("Reverter Ind. Guarda Permanente").descr("Reverter a indicação do documento para o Arquivo Permanente.").icone("buildinge_delete").nameSpace("/app/expediente/mov").acao("reverter_indicacao_permanente")

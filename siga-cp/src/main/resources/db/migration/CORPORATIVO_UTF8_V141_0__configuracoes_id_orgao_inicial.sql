--configurações ativas para o orgao inicial que precisam ser desativadas
update corporativo.cp_configuracao set HIS_DT_FIM = sysdate, his_idc_fim = his_idc_ini where id_configuracao in (
...
where conf.HIS_DT_FIM is null and id_orgao_usu_inicial = org.id_orgao_usu and id_orgao_usu_inicial in (

	...
	<div class="gt-bd clearfix">
		<div class="gt-content clearfix">
			...
			<form name="frm" action="principal" namespace="/" method="get" theme="simple">
				<input type="button" value="Imprimir" class="gt-btn-medium gt-btn-left"	onclick="javascript: document.body.offsetHeight; window.print();" />
				<c:if test="${popup != true}">
					<input type="button" value="Voltar" class="gt-btn-medium gt-btn-left" onclick="javascript:history.back();history.back();" />
				</c:if>
			</form>
			<br /> <br />
			<div>

...
@Controller
public class ConfiguracaoNotificaoPorEmailController extends GiControllerSupport {
	 ...
	 */
	public ConfiguracaoNotificaoPorEmailController() {
		super();
	}

	@Inject
	public ConfiguracaoNotificaoPorEmailController(HttpServletRequest request, Result result, CpDao dao, SigaObjects so, EntityManager em) {
	...
	public void editar (String siglaServ, Integer idSituacao) throws Exception {
		...
		result.redirectTo(ConfiguracaoNotificaoPorEmailController.class).listar();
	}

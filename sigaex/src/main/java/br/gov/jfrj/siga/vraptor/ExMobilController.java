...
public class ExMobilController extends
	...
	public String aSelecionar(String sigla) throws Exception {
		String s = super.aSelecionar(sigla);
	...
	public void aCarregarListaFormas(Long tipoForma, int idFormaDoc)
			throws Exception {
		this.setIdFormaDoc(idFormaDoc);
		setIdTipoFormaDoc(tipoForma);

		result.include("todasFormasDocPorTipoForma",
				this.getTodasFormasDocPorTipoForma());
		;
	...
	public String aOtimizarIndices() {
		FullTextSession fullTextSession = Search.getFullTextSession(ExDao
	...
	public void aCarregarListaModelos(int forma, Long idMod) throws Exception {
		this.setIdMod(idMod);
		setIdFormaDoc(forma);

		result.include("modelos", this.getModelos());
	}
	...
	public Map<Integer, String> getListaVisualizacao() {
		final Map<Integer, String> map = new TreeMap<Integer, String>();
		map.put(0, "Normal");
	...
	public List<ExFormaDocumento> getTodasFormasDocPorTipoForma()
		...
		bl.obterListaModelos(null, false, null, false, getTitular(),
				getLotaTitular(), false), null, tipoForma));
		return formasDoc;

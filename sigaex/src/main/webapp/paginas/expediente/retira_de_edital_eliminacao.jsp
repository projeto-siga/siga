...
function sbmt() {
	...
	ExMovimentacaoForm.acao.value='aRetirarDeEditalEliminacao';
...
<c:if test="${not mob.doc.eletronico}">
	...
	<div class="gt-bd clearfix">
		<div class="gt-content clearfix">
			...
			<h2>Retirada de Edital de Elimina̤̣o - ${mob.siglaEDescricaoCompleta}</h2>

			<div class="gt-content-box gt-for-table">

			<ww:form action="retirar_de_edital_eliminacao_gravar"

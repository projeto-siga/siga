...
public class ExCompetenciaBL extends CpCompetenciaBL {
	...
	public boolean pode(Class<? extends Expression> clazz, final DpPessoa titular, final DpLotacao lotaTitular, final ExMobil mob) {
		try {
			return clazz.getDeclaredConstructor(ExMobil.class, DpPessoa.class, DpLotacao.class).newInstance(mob, titular, lotaTitular).eval();
		} catch (Exception e) {
	 ...
	 * @throws Exception
	 */
	public Boolean podePorConfiguracao(DpPessoa titular,

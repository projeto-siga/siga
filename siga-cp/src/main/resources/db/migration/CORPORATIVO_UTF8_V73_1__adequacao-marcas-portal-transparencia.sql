...
UPDATE corporativo.cp_marca set id_marcador = 1007 where id_marcador = 1008; /*de-para */
DELETE FROM CORPORATIVO.CP_MARCADOR where id_marcador = 1008;
commit;

/* Alteração do Marcador COVID-19 para Taxonomia Administrada */
UPDATE corporativo.cp_marca set id_tp_marcador = 6 where id_marcador = 1006; /* taxonomia gerenciada */
commit;

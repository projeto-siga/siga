...
<siga:pagina titulo="Listagem de Documentos por Classificação">
	<script type="text/javascript"
		src="/sigaex/javascript/sequential-ajax-calls.js"></script>
	...
	<div class="gt-bd clearfix">
		<div class="gt-content clearfix">
			<h2>Listagem de Documentos por Classificação</h2>
			<form name="frm" id="frm" cssClass="form" theme="simple">
				...
				<div class="gt-content-box gt-for-table">
					<table class="gt-form-table">
						<tr class="header">
							<td>Alterar nivel de acesso</td>
						</tr>
						<tr>
							<td colspan="2"><select name="nivelAcesso" id="nivelAcesso">
						...
						<tr class="button">
							<td colspan="2"><a class="gt-btn-small"
								href="javascript: executaOperacoesEmLote();">Gravar</a></td>
						</tr>
					</table>
				</div>
				<br />
							...
							<tbody>
								<c:forEach var="doc" items="${lista}">
									...
									<tr class="even">
										...
										<td style="text-align: center"><c:if test="${true}">
									...
									<input type="hidden" name="process_descr_${doc.idDoc}"
										value="${doc.sigla}" />
									<input type="hidden" name="process_url_post_${doc.idDoc}"
										value="/sigaex/app/expediente/mov/redefinir_nivel_acesso_gravar" />
								</c:forEach>
							</tbody>
						</table>
					</div>

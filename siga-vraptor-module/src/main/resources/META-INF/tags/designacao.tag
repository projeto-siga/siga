			...
			<tbody>
				<c:forEach items="${requestScope[designacoes]}" var="design">
					<tr data-json-id="${design.id}" data-json='${design.toVO().toJson()}'
						onclick="designacaoService.editar($(this).data('json'), 'Alterar Designa��o')"
...
<siga:modal nome="designacao" titulo="Cadastrar Designa��o">
...
<script type="text/javascript">
	...
	designacaoService.onRowClick = function(designacao) {
		designacaoService.editar(designacao, 'Alterar designa��o');
	}
	/**
	...
	designacaoService.adicionarLinha = function(table, design) {
		...
		tr.on('click', function() {
			...
			designacaoService.editar(json, 'Alterar designa��o');
		});

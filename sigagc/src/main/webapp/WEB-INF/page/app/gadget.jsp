	...
	<table border="0" class="gt-table">
		...
		<c:forEach var="contagem" items="${items:contagens}">
			<tr>
				...
				<td align="right" ><a href="${linkTo[AppController].listar}?filtro.situacao=${contagem[0]}&filtro.lotaResponsavel=${lotaTitular.idLotacao}&filtro.pesquisa=true">${contagem[3]}</a></td>
			</tr>
		</c:forEach>
		</tbody>
	</table>

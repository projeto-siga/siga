...
<siga:pagina titulo="Não foi possível completar a operação">
						...
						<tr>
							<td align="center" valign="middle">
								<table class="form" width="50%">
									<tbody>
										<tr>
											<td style="text-align: center; padding-top: 10px;"><h3>${message}</h3>
											</td>
										</tr>
									</tbody>
								</table>
						...
						<tr>
							<td style="text-align: center; padding: 0;">
								<div style="display: none; padding: 8pt;" align="left" id="stack">
									...
									<pre style="font-size: 8pt;">${stackTrace}</pre>
								</div>
							</td>
						</tr>
					</tbody>

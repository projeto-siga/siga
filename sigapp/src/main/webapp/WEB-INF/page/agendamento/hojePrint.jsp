...
<html>
 ...
 <script language="javascript">	alert('Quando terminar tecle BACKSPACE para retornar.'); </script>
 </head>
 <body>
 <center>
 ...
 <div name="relatorio" style="font-family: arial, calibri;">
	...
	<div name="data do cabecalho" style="position: absolute; left: 10%;">
		DATA:
		<c:if
			test="${null != listAgendamentos || null != listAgendamentos[0]}">
			<fmt:formatDate pattern="dd/MM/yyyy" value="${listAgendamentos[0].data_ag}" />
		</c:if>
	</div>
	<br>
	<br>

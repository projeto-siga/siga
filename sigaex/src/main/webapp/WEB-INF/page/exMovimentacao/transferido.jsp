...
<script language="javascript">
	...
	function mostraProtocolo(){
		...
		window.open('/sigaex/app/expediente/mov/protocolo_unitario?popup=true&id=${mov.idMov}','${id}','width='+width+',height='+height+', scrollbars=1, resizable=1, top='+top+', left='+left);

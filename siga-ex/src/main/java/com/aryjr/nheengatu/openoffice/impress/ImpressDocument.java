...
/**
 * 
 * Can generate a Impress document of OpenOffice.
 * 
 * @version $Id: ImpressDocument.java,v 1.1 2007/12/26 15:57:43 tah Exp $
...
public class ImpressDocument extends Document {
	 ...
	 * 
	 * @param name
	 *            The name without the extencion ".sxi".
	 */
	public ImpressDocument(final String name) {
		setName(name + ".sxi");
	}
	 ...
	 *            The name without the extencion ".sxi".
	 */
	public ImpressDocument(final String path, final String name) {
		setPath(path);
		setName(name + ".sxi");
	}
 ...
 * 
 * Revision 1.2 2005/12/16 14:06:35 aryjr Problem with cell heights solved!!!
 * 

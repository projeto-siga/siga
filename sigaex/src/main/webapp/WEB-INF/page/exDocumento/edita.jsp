...
<siga:pagina titulo="Novo Documento">
	...
	<script type="text/javascript"
		src="/ckeditor/ckeditor/ckeditor.js?v=4.15.0.L0FJ.c71958523b"></script>
	<script type="text/javascript"
	...
	<c:set var="timeoutMod" scope="session"
		value="${f:resource('/siga.session.modelos.tempo.expiracao')}" />

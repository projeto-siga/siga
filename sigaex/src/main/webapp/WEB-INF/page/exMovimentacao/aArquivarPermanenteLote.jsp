					...
					<div class="col-sm-2">
						<div class="form-group">
							<div class="form-group form-check mt-4">
								<input type="checkbox" class="form-check-input " name="substituicao" id="substituicao" value="${substituicao}" onclick="javascript:displayTitular(this);" />
				...
				<div class="row">
					...
					<div class="col-sm-6">
						<div class="form-group">
							...
							<input type="text" name="nmFuncaoSubscritor" maxLength="128" value="${nmFuncaoSubscritor}" class="form-control" />

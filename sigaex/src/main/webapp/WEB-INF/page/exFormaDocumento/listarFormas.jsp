						...
						<div class="col-sm-4">
							<div class="form-group">
								<div class="form-check form-check-inline">						
									<input type="radio" id="order1" name="ordenar" value="descricao" onclick="this.form.submit();" class="form-check-input"><label class="form-check-label" for="order1">Descri&ccedil;&atilde;o</label>
									<input type="radio" id="order2" name="ordenar" value="sigla" onclick="this.form.submit();" class="form-check-input ml-2"><label class="form-check-label" for="order2">Sigla</label>
								</div>	
							</div>	
						</div>				
					</form>

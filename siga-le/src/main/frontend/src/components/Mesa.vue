      ...
      <div class="col-sm-12">
            ...
            <template v-for="f in filtrados">
              ...
              <th style="text-align: center">
                <input type="checkbox" id="progress_checkall" name="progress_checkall" v-model="todos[f.grupo]" @change="marcarTodos(f.grupo)" />
              </th>
                ...
                <input type="checkbox" v-model="f.checked" :disabled="f.disabled" />
								...
								<td class="d-none d-md-block" style="padding: 0;"><div  class="xrp-label-container">
									<!-- class="list-unstyled blog-tags" -->
										<span v-for="m in f.list"  :key="f.sigla + ':tag:' + m.nome" :title="m.titulo"><button

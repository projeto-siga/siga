...
<siga:pagina titulo="Tramitar em Paralelo">
	...
	<script type="text/javascript" language="Javascript1.1">
		function sbmt() {
			document.getElementById('tramitar_gravar_sigla').value = '${mob.sigla}';
			document.getElementById('tramitar_gravar_pai').value = '';
			frm.action = 'tramitar_paralelo?sigla=VALOR_SIGLA&popup=true'.replace(
					'VALOR_SIGLA', document
							.getElementById('tramitar_gravar_sigla').value);
			frm.submit();
		}
	...
	<div class="container-fluid">
		<div class="card bg-light mb-3">
			<div class="card-header">
				<h5>Tramitar em Paralelo - ${mob.siglaEDescricaoCompleta}</h5>
			</div>
			<div class="card-body">

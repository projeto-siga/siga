					...
					<table class="gt-form-table">
						...
						<tr>
							...
							<td>
								...
								<input type="text" name="nmFuncaoSubscritor" value="${nmFuncaoSubscritor}" size="50" maxLength="128" theme="simple"/> 
								(opcional)
							</td>
						</tr>
						<tr>
							...
							<td>
								<textarea name="descrMov" value="${descrMov}" cols="60" rows="5" onkeydown="corrige();tamanho();" maxlength="255" onblur="tamanho();"
						...
						<c:if test="${tipoResponsavel == 3}">
							<tr>
								...
								<td>
									<input type="text" value="${obsOrgao}" size="30" name="obsOrgao" />
								</td>
							</tr>
						</c:if>

...
<siga:pagina titulo="Movimentação">
	...
	<div class="gt-bd clearfix">
		<div class="gt-content clearfix">
			...
			<h2>Reversão de Indicação para Guarda Permanente - ${mob.siglaEDescricaoCompleta}</h2>
			...
			<div class="gt-content-box gt-for-table">
				...
				<form action="${request.contextPath}/app/expediente/mov/reverter_indicacao_permanente_gravar" enctype="multipart/form-data" method="post">
					...
					<table class="gt-form-table">
						<tr class="header">
							<td colspan="2">Dados da reversão</td>
						</tr>
						<tr>
							<td>
								<label>Data:</label>
						...
						<td colspan="2">
							...
							<input type="button" value="Cancela" onclick="javascript:history.back();" class="gt-btn-small gt-btn-left" /></td>
						</tr>
				</table>
			</form>

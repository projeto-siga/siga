...
public class CorreioSinc {
	...
	public static String obterHTMLEmailParaUsuarioExternoAssinarDocumento(String uri, String siglaDocumento, String siglaUsuario) {
		...
		sbHtml.append("					<img style='padding: 10px 0px; text-align: center;' src='https://www.documentos.spsempapel.sp.gov.br/siga/imagens/brasao_sp_col.png' alt='SP Sem Papel' width='70' height='80' />");		
		sbHtml.append("				</td>");
		sbHtml.append("			</tr>");
		sbHtml.append("			<tr>");

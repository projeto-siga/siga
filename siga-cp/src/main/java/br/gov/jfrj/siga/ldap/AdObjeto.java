...
public abstract class AdObjeto extends SincronizavelSuporte implements Comparable, Serializable {
	...
	@Desconsiderar
	private Set<AdGrupo> membroDe = new HashSet<AdGrupo>();
	 ...
	 * @return
	 */
	public Set<AdGrupo> getGruposPertencentes() {
		return membroDe;
	}

	public String getNome() {
		return Texto.removeAcento(nome);
	}
	...
	public String getNomeCompleto() {
		return getPrefixo() + getNome() + "," + (getGrupoPai() == null ? dnDominio : getGrupoPai().getNomeCompleto());
	}

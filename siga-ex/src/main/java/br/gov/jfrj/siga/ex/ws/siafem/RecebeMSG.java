    ...
    extends Service
{
    ...
    private final static QName RECEBEMSG_QNAME = new QName("https://www.bec.sp.gov.br/SIAFISICO/RecebeMSG/", "recebeMSG");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://siafemhom.intra.fazenda.sp.gov.br/siafisico/RecebeMSG.asmx?WSDL");
    ...
    public RecebeMSGSoap getRecebeMSGSoap() {
        return super.getPort(new QName("https://www.bec.sp.gov.br/SIAFISICO/RecebeMSG/", "recebeMSGSoap"), RecebeMSGSoap.class);
    }
    ...
    public RecebeMSGSoap getRecebeMSGSoap(WebServiceFeature... features) {
        return super.getPort(new QName("https://www.bec.sp.gov.br/SIAFISICO/RecebeMSG/", "recebeMSGSoap"), RecebeMSGSoap.class, features);
    }
    ...
    public RecebeMSGSoap getRecebeMSGSoap12() {
        return super.getPort(new QName("https://www.bec.sp.gov.br/SIAFISICO/RecebeMSG/", "recebeMSGSoap12"), RecebeMSGSoap.class);
    }
    ...
    public RecebeMSGSoap getRecebeMSGSoap12(WebServiceFeature... features) {
        return super.getPort(new QName("https://www.bec.sp.gov.br/SIAFISICO/RecebeMSG/", "recebeMSGSoap12"), RecebeMSGSoap.class, features);
    }
    ...
    public RecebeMSGHttpGet getRecebeMSGHttpGet() {
        return super.getPort(new QName("https://www.bec.sp.gov.br/SIAFISICO/RecebeMSG/", "recebeMSGHttpGet"), RecebeMSGHttpGet.class);
    }
    ...
    public RecebeMSGHttpGet getRecebeMSGHttpGet(WebServiceFeature... features) {
        return super.getPort(new QName("https://www.bec.sp.gov.br/SIAFISICO/RecebeMSG/", "recebeMSGHttpGet"), RecebeMSGHttpGet.class, features);
    }
    ...
    public RecebeMSGHttpPost getRecebeMSGHttpPost() {
        return super.getPort(new QName("https://www.bec.sp.gov.br/SIAFISICO/RecebeMSG/", "recebeMSGHttpPost"), RecebeMSGHttpPost.class);
    }
    ...
    public RecebeMSGHttpPost getRecebeMSGHttpPost(WebServiceFeature... features) {
        return super.getPort(new QName("https://www.bec.sp.gov.br/SIAFISICO/RecebeMSG/", "recebeMSGHttpPost"), RecebeMSGHttpPost.class, features);
    }
